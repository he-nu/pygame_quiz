...
def set_colors_for_level(level, objects):
    if level == 1:
        set_button_colors((0, 100, 0), (57, 255, 20), objects)
    elif level == 2:
        set_button_colors((0, 100, 0), (57, 255, 20), objects)
...
def set_button_colors(dark_inside, neon_border, objects):
    ...
    left_button.set_color_inside(neon_border)
    middle_button.set_color_border(neon_border)
    middle_button.set_color_inside(neon_border)
    right_button.set_color_border(neon_border)
    right_button.set_color_inside(neon_border)
...
def game(screen):
    ...
    while True:
        ...
        if level == 2:
            set_colors_for_level(1, [left_button, middle_button, right_button, question_text_area,
                                 question_option_area, question_number_text, correct_answers_text])
        if level == 3:
            set_colors_for_level(2, [left_button, middle_button, right_button, question_text_area,
                                 question_option_area, question_number_text, correct_answers_text])
...
def handle_button_click(screen, left_button, middle_button, right_button, mouse_pos, correct_ans, feedback_element: Text):
    if left_button.was_pressed(mouse_pos):
        ...
        button_correct_animation(screen, right_button, feedback_element, True)
        if correct_ans == 'C':
            return "correct"
        else:
            button_correct_animation(
